this.stronghold_management_building_village <- this.inherit("scripts/entity/world/settlements/buildings/building", {
	...
	function create()
	{
		...
		this.m.ID = "building.management_building_village";
