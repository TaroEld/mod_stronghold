...
gt.Stronghold.MaxMenuOptionsLen <- 9; // max length of menu options, limitation of the text window size. got it at 11 so leave 2 spaces for 'back' etc
gt.Stronghold.PriceMult <- 1000; //fastest way to change prices, everything gets mult by this
gt.Stronghold.BuyPrices <- [10, 20, 20]; //base prices for build/upgrade
gt.Stronghold.MaxAttachments <- [3, 6, 9]; //base prices for build/upgrade
...
gt.Stronghold.RoadCost <- 0.5; // per segment
